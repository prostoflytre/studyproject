...
def parse_readme():
    """
    Функция читает и анализирует файл REDME004.md, чтобы извлечь информацию.
    """
    college = None
    course = None
    name = None
    ...
    try:
        ...
        print("Ошибка: Файл REDME004.md не найден в текущей директории.")
...
def main():
    ...
    print("Читаю информацию из REDME004.md...")
    print()
