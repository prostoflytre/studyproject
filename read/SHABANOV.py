...
def parse_readme_002():
    """
    Функция читает и анализирует файл README002.md, чтобы извлечь информацию.
    """
    college = None
    course = None
    name = None
    ...
    try:
        ...
        file_path = os.path.join(folder_path, 'README002.md')
        ...
        print("Ошибка: Файл README002.md не найден в текущей директории.")
...
def main():
    ...
    if not all([college, course, name, group, id ]):
        print("❌ В README002.md не найдена вся необходимая информация.")
