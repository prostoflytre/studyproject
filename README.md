...
* Пишем: `Git: Clone`, нажимаем клавишу `Enter`, пишем: `https://github.com/prostoflytre/studyproject.git`, соглашаемся на всё.
...
- ## Скрипты UDIN.py, SHABANOV.py, MIROSHKIN.py, MALINEVSKIY.py
    ...
    -   ## 🚀 Пример UDIN.py
        ...
        Читаю информацию из README001.md...
...
- ## Скрипт read_readme00.py
    ...
    -   ## 🎯 Общее описание
        ...
        Программа для управления файлами `README00X.md` с информацией о студентах. Позволяет просматривать, создавать и читать записи о студентах в удобном формате.
