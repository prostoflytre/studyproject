# 📚 studyproject - Репозиторий учебного проекта

## 🧭 Оглавление

1.  [👥 Команда и контекст](#-команда-и-контекст)
2.  [📁 Описание файлов](#-описание-файлов)
3.  [🐍 Описание скриптов](#-описание-скриптов)
    *   [Скрипты участников (UDIN.py, SHABANOV.py, ...)](#скрипты-участников-udinpy-shabanovpy-)
    *   [Утилита read_readme00.py](#утилита-read_readme00py)
...
### Файлы `README00*.md`
Файлы с информацией об участниках команды. Нумерация соответствует конкретному участнику.
...
- ## Скрипты UDIN.py, SHABANOV.py, MIROSHKIN.py, MALINEVSKIY.py
    ...
    -   ## 🚀 Пример UDIN.py
        ...
        Желаем успехов в обучении! 🚀
        ```
>>>>>>> b405810325be4c1dd682be7f571a3ac58f558149
