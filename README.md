...
2.  [Как скачать репозиторий?](#как-скачать-репозиторий)
3.  [📖 Техническая документация](#-техническая-документация)
    1.  [Файлы README00*.md](#файлы-readme00md)
        1.  [Описание](#описание)
        2.  [🚀 Пример README001.md](#-пример-readme001md)
    2.  [Скрипты UDIN.py, SHABANOV.py, MIROSHKIN.py, MALINEVSKIY.py](#скрипты-udinpy-shabanovpy-miroshkinpy-malinevskiypy)
        1.  [Описание](#описание-1)
        2.  [🚀 Пример UDIN.py](#-пример-udinpy)
    3.  [Скрипт read_readme00.py](#скрипт-read_readme00py)
        1.  [🎯 Общее описание](#-общее-описание)
        2.  [📁 Структура проекта](#-структура-проекта)
        3.  [⚙️ Функциональные модули](#️-функциональные-модули)
        4.  [🔄 Основной цикл программы](#-основной-цикл-программы)
        5.  [🛡️ Обработка ошибок](#️-обработка-ошибок)
        6.  [📋 Требования к окружению](#-требования-к-окружению)
        7.  [⚠️ Ограничения](#️-ограничения)
